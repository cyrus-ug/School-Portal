...
try {
    $stmt = $pdo->prepare('SELECT id, name, email, role, status FROM users WHERE id = ? AND tenant_id = ? AND deleted_at IS NULL');
            ...
            <div class="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 px-8 py-4 sticky top-0 z-10">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-slate-600 dark:text-slate-400 text-sm mt-1"><?php echo htmlspecialchars($user['name']); ?></p>
                    </div>
            ...
            <div class="p-8">
                <div class="max-w-3xl">
                    ...
                    <form method="POST" class="bg-white dark:bg-slate-900 rounded-xl p-8 border border-slate-200 dark:border-slate-800 space-y-6">
                        ...
                        <!-- Security (Optional) -->
                        <div>
                            <h2 class="text-lg font-semibold mb-4">Change Password (Optional)</h2>
                            <p class="text-sm text-slate-600 dark:text-slate-400 mb-4">Leave blank to keep current password</p>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">Change user role to update permissions</p>
                                </div>
                                <div>
